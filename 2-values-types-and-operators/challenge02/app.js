...
faça com que a obtenção da última letra funcione para qualquer palavra 
que a "randomWord" receber;
...
- Exiba, no console, o index da última ocorrência do caractere "n" 
da "winterMessage".
*/
...
// console.log([harryPotterAuthor[0], harryPotterAuthor[1], harryPotterAuthor[2],harryPotterAuthor[3]].join(''))
...
let newName = name[0].toLocaleUpperCase() + name.slice(1, 5) + ' ' + name[7].toLocaleUpperCase() + name.slice(8)
...
console.log(`${name[0].toLocaleUpperCase() + name.slice(1, 5)} ${name[7].toLocaleUpperCase() + name.slice(8)}`)