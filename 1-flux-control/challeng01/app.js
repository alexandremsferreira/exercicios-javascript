...
const my3FavoriteTVShows = ['Big Bang', 'Suits', 'The Sinner', 'Watchmen']
...
const randowLengthTypeSentence = 39
const booStrTypeSentence = (typeSentence.length > randowLengthTypeSentence).toString()

// console.log(`A string que a "typeSentence" armazena tem mais de ${randowLengthTypeSentence}  
// caracteres? ${booStrTypeSentence[0][0].toLocaleUpperCase() + booStrTypeSentence.slice(1)}.`)
